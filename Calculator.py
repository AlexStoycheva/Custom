...
btn_multiplication = tk.Button(root, text='*', command=lambda: add_to_calculation('*'), width=5, font='Ariel, 14')
btn_multiplication.grid(row=4, column=4)

btn_division = tk.Button(root, text='/', command=lambda: add_to_calculation('/'), width=5, font='Ariel, 14')
btn_division.grid(row=5, column=4)

btn_left_parentheses = tk.Button(root, text='(', command=lambda: add_to_calculation('('), width=5, font='Ariel, 14')
btn_left_parentheses.grid(row=5, column=1)

btn_right_parentheses = tk.Button(root, text=')', command=lambda: add_to_calculation(')'), width=5, font='Ariel, 14')
btn_right_parentheses.grid(row=5, column=3)
